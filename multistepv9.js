var projekt, Radio_4, seitens, komplex, design, editor, seiten, produkte, beratung, zusatz, zeit, ecommercepages, senden;


var we_tabs_next_button = '[bloc=next-q]';
    var we_tabs_prev_button = '[bloc=prev-q]';
    ...
    }$("[name=Radio_4]").on("input", function () {
    Radio_4 = getValueFromInput("Radio_4");
      if (Radio_4 == 'webseitenn') {
        ...
        $($('[data-w-tab=seiten]')).attr('prev-tab',we_activeTab);

        } else if (Radio_4 == 'onlineshopprojekt') {
        ...
        $(we_tabs_next_button).addClass(we_tabs_active_class);
        $(".w--tab-active").attr('next-tab',nextTab);
        $($('[data-w-tab=produkte]')).attr('prev-tab',we_activeTab);

        } else if (Radio_4 == 'indieprojekt') {
        ...
        $(we_tabs_next_button).addClass(we_tabs_active_class);
        $(".w--tab-active").attr('next-tab',nextTab);
        $($('[data-w-tab=beratung]')).attr('prev-tab',we_activeTab);

        }
});

    $("[name=Radio_4]").parent("label.w-radio").on("click", function () {
    ...
    $("[name=seitens]").on("input", function () {
    seitens = getValueFromInput("seitens");
      ...
      $(we_tabs_next_button).addClass(we_tabs_active_class);
      $(".w--tab-active").attr('next-tab',nextTab);
      $($('[data-w-tab=design]')).attr('prev-tab',we_activeTab);

      });

    $("[name=seitens]").parent("label.w-radio").on("click", function () {
      clickedRadioButtonValue = $("input", this).val();
      seitens = getValueFromInput("seitens");
    ...
    $("[name=komplex]").on("input", function () {
    komplex = getValueFromInput("komplex");
      ...
      $(we_tabs_next_button).addClass(we_tabs_active_class);
      $(".w--tab-active").attr('next-tab',nextTab);
      $($('[data-w-tab=zusatz]')).attr('prev-tab',we_activeTab);

      });

    $("[name=komplex]").parent("label.w-radio").on("click", function () {
      clickedRadioButtonValue = $("input", this).val();
      komplex = getValueFromInput("komplex");
    ...
    editor = getValueFromInput("editor");
    ...
    $("[name=editor]").parent("label.w-radio").on("click", function () {
      clickedRadioButtonValue = $("input", this).val();
      editor = getValueFromInput("editor");
    ...
    $("[name=zeit]").on("input", function () {
    zeit = getValueFromInput("zeit");
    ...
    $("[name=zeit]").parent("label.w-radio").on("click", function () {
      clickedRadioButtonValue = $("input", this).val();
      zeit = getValueFromInput("zeit");
    ...
    $("[name=ecommercepages]").on("input", function () {
    ecommercepages = getValueFromInput("ecommercepages");
      ...
      $(we_tabs_next_button).addClass(we_tabs_active_class);
      $(".w--tab-active").attr('next-tab',nextTab);
      $($('[data-w-tab=senden]')).attr('prev-tab',we_activeTab);

      });

    $("[name=ecommercepages]").parent("label.w-radio").on("click", function () {
      clickedRadioButtonValue = $("input", this).val();
      ecommercepages = getValueFromInput("ecommercepages");
    ...
    $('[bloc=next-q]').on('click',function() {
  if($('.w--tab-active').attr('data-w-tab')=='zusatz') {
...
$('[bloc=sent]').on('click',function() {
  if($('.w--tab-active').attr('data-w-tab')=='senden') {
          $('[bloc=prev-q]').css({
      'display':'none',
    });
