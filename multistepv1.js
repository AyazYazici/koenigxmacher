var projekt, Radio_4, seitens, input_name, design, seiten, produkte, beratung, komplex, zusatz, editor;
...
var we_tabs_next_button = '[bloc=next-q]';
    ...
    $("[name=input_name]").on("input", function () {
    input_name = getValueFromInput("input_name");
      if (komplex == !null) {
    ...
    $("[name=input_name]").parent("label.w-radio").on("click", function () {
      clickedRadioButtonValue = $("input", this).val();
      input_name = getValueFromInput("input_name");
        if (komplex == !null) {
